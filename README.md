...
Aplicación desarrollada en Java que implementa el famoso juego de las parejas encadenadas con 
...
(alojadas en la carpeta 'src/recursos') con los personajes para poder probar la aplicación.
